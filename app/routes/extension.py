...
def create_scene_subtitles(
    ...
    Uses OpenAI Whisper for precise synchronization if audio_path is provided.
    """
    ...
    if not chunks:
        ...
        for i, s in enumerate(scenes):
            # Prefer dialogue (chosen language text), fallback to dialogue_english
            dialogue = (s.get("dialogue") or s.get("dialogue_english") or "").strip()
